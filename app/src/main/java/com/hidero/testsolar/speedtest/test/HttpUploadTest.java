package com.hidero.testsolar.speedtest.test;
...
import static com.hidero.testsolar.speedtest.test.HttpUploadTest.uploadedKByte;
...
public class HttpUploadTest extends Thread {
    ...
    public static int uploadedKByte = 0;
